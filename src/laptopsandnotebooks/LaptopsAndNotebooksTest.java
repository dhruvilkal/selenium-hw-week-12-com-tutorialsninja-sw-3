...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException{
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Darshan");
        sendTextToElement(By.id("input-payment-lastname"), "Kalathiya");
        sendTextToElement(By.id("input-payment-email"), "darshan@gmail.com");
        ...
        sendTextToElement(By.id("input-payment-postcode"), "E11 223");
