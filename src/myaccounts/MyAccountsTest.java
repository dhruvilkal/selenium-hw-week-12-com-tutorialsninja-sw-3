...
public class MyAccountsTest extends Utility {
    ...
    public void VerifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "Dhruvil");
        sendTextToElement(By.id("input-lastname"), "Kalathiya");
        sendTextToElement(By.id("input-email"), "abc1@gmail.com");
        sendTextToElement(By.id("input-telephone"), "07587402062");
        sendTextToElement(By.id("input-password"), "Prime@321");
        sendTextToElement(By.id("input-confirm"), "Prime@321");
